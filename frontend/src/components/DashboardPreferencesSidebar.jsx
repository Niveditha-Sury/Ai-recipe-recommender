...
export function DashboardPreferencesSidebar({
    ...
    return (
        <div className="order-2 lg:order-0 lg:col-span-5 lg:col-start-8 lg:row-start-1 lg:row-span-2 bg-brand-card lg:bg-transparent rounded-card lg:rounded-none border lg:border-none border-brand-primary/20 p-6 lg:p-0 shadow-sm lg:shadow-none mb-4 lg:mb-0 lg:sticky lg:top-[120px] lg:h-max">
